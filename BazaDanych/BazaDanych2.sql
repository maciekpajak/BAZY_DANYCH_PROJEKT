...
-- Zrzut struktury tabela information_schema.ALL_PLUGINS
...
-- Zrzut struktury tabela information_schema.APPLICABLE_ROLES
...
-- Zrzut struktury tabela information_schema.CHARACTER_SETS
...
-- Zrzut struktury tabela information_schema.CHECK_CONSTRAINTS
...
-- Zrzut struktury tabela information_schema.CLIENT_STATISTICS
...
-- Zrzut struktury tabela information_schema.COLLATIONS
...
-- Zrzut struktury tabela information_schema.COLLATION_CHARACTER_SET_APPLICABILITY
...
-- Zrzut struktury tabela information_schema.COLUMNS
...
-- Zrzut struktury tabela information_schema.COLUMN_PRIVILEGES
...
-- Zrzut struktury tabela information_schema.ENABLED_ROLES
...
-- Zrzut struktury tabela information_schema.ENGINES
...
-- Zrzut struktury tabela information_schema.EVENTS
...
-- Zrzut struktury tabela information_schema.FILES
...
-- Zrzut struktury tabela information_schema.GEOMETRY_COLUMNS
...
-- Zrzut struktury tabela information_schema.GLOBAL_STATUS
...
-- Zrzut struktury tabela information_schema.GLOBAL_VARIABLES
...
-- Zrzut struktury tabela information_schema.INDEX_STATISTICS
...
-- Zrzut struktury tabela information_schema.INNODB_BUFFER_PAGE
...
-- Zrzut struktury tabela information_schema.INNODB_BUFFER_PAGE_LRU
...
-- Zrzut struktury tabela information_schema.INNODB_BUFFER_POOL_STATS
...
-- Zrzut struktury tabela information_schema.INNODB_CMP
...
-- Zrzut struktury tabela information_schema.INNODB_CMPMEM
...
-- Zrzut struktury tabela information_schema.INNODB_CMPMEM_RESET
...
-- Zrzut struktury tabela information_schema.INNODB_CMP_PER_INDEX
...
-- Zrzut struktury tabela information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- Zrzut struktury tabela information_schema.INNODB_CMP_RESET
...
-- Zrzut struktury tabela information_schema.INNODB_FT_BEING_DELETED
...
-- Zrzut struktury tabela information_schema.INNODB_FT_CONFIG
...
-- Zrzut struktury tabela information_schema.INNODB_FT_DEFAULT_STOPWORD
...
-- Zrzut struktury tabela information_schema.INNODB_FT_DELETED
...
-- Zrzut struktury tabela information_schema.INNODB_FT_INDEX_CACHE
...
-- Zrzut struktury tabela information_schema.INNODB_FT_INDEX_TABLE
...
-- Zrzut struktury tabela information_schema.INNODB_LOCKS
...
-- Zrzut struktury tabela information_schema.INNODB_LOCK_WAITS
...
-- Zrzut struktury tabela information_schema.INNODB_METRICS
...
-- Zrzut struktury tabela information_schema.INNODB_MUTEXES
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_COLUMNS
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_DATAFILES
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_FIELDS
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_FOREIGN
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_FOREIGN_COLS
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_INDEXES
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_SEMAPHORE_WAITS
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_TABLES
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_TABLESPACES
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_TABLESTATS
...
-- Zrzut struktury tabela information_schema.INNODB_SYS_VIRTUAL
...
-- Zrzut struktury tabela information_schema.INNODB_TABLESPACES_ENCRYPTION
...
-- Zrzut struktury tabela information_schema.INNODB_TABLESPACES_SCRUBBING
...
-- Zrzut struktury tabela information_schema.INNODB_TRX
...
-- Zrzut struktury tabela information_schema.KEY_CACHES
...
-- Zrzut struktury tabela information_schema.KEY_COLUMN_USAGE
...
-- Zrzut struktury tabela information_schema.OPTIMIZER_TRACE
...
-- Zrzut struktury tabela information_schema.PARAMETERS
...
-- Zrzut struktury tabela information_schema.PARTITIONS
...
-- Zrzut struktury tabela information_schema.PLUGINS
...
-- Zrzut struktury tabela information_schema.PROCESSLIST
...
-- Zrzut struktury tabela information_schema.PROFILING
...
-- Zrzut struktury tabela information_schema.REFERENTIAL_CONSTRAINTS
...
-- Zrzut struktury tabela information_schema.ROUTINES
...
-- Zrzut struktury tabela information_schema.SCHEMATA
...
-- Zrzut struktury tabela information_schema.SCHEMA_PRIVILEGES
...
-- Zrzut struktury tabela information_schema.SESSION_STATUS
...
-- Zrzut struktury tabela information_schema.SESSION_VARIABLES
...
-- Zrzut struktury tabela information_schema.SPATIAL_REF_SYS
...
-- Zrzut struktury tabela information_schema.STATISTICS
...
-- Zrzut struktury tabela information_schema.SYSTEM_VARIABLES
...
-- Zrzut struktury tabela information_schema.TABLES
...
-- Zrzut struktury tabela information_schema.TABLESPACES
...
-- Zrzut struktury tabela information_schema.TABLE_CONSTRAINTS
...
-- Zrzut struktury tabela information_schema.TABLE_PRIVILEGES
...
-- Zrzut struktury tabela information_schema.TABLE_STATISTICS
...
-- Zrzut struktury tabela information_schema.TRIGGERS
...
-- Zrzut struktury tabela information_schema.USER_PRIVILEGES
...
-- Zrzut struktury tabela information_schema.USER_STATISTICS
...
-- Zrzut struktury tabela information_schema.user_variables
...
-- Zrzut struktury tabela information_schema.VIEWS
...
-- Zrzut struktury bazy danych mysql
CREATE DATABASE IF NOT EXISTS `mysql` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mysql`;

-- Zrzut struktury tabela mysql.columns_priv
...
-- Zrzut struktury tabela mysql.column_stats
...
-- Zrzut struktury tabela mysql.db
...
-- Zrzut struktury tabela mysql.event
...
-- Zrzut struktury tabela mysql.func
...
-- Zrzut struktury tabela mysql.general_log
...
-- Zrzut struktury tabela mysql.global_priv
...
-- Zrzut struktury tabela mysql.gtid_slave_pos
...
-- Zrzut struktury tabela mysql.help_category
...
-- Zrzut struktury tabela mysql.help_keyword
...
-- Zrzut struktury tabela mysql.help_relation
...
-- Zrzut struktury tabela mysql.help_topic
...
-- Zrzut struktury tabela mysql.index_stats
...
-- Zrzut struktury tabela mysql.innodb_index_stats
...
-- Zrzut struktury tabela mysql.innodb_table_stats
...
-- Zrzut struktury tabela mysql.plugin
...
-- Zrzut struktury tabela mysql.proc
...
-- Zrzut struktury tabela mysql.procs_priv
...
-- Zrzut struktury tabela mysql.proxies_priv
...
-- Zrzut struktury tabela mysql.roles_mapping
...
-- Zrzut struktury tabela mysql.servers
...
-- Zrzut struktury tabela mysql.slow_log
...
-- Zrzut struktury tabela mysql.tables_priv
...
-- Zrzut struktury tabela mysql.table_stats
...
-- Zrzut struktury tabela mysql.time_zone
...
-- Zrzut struktury tabela mysql.time_zone_leap_second
...
-- Zrzut struktury tabela mysql.time_zone_name
...
-- Zrzut struktury tabela mysql.time_zone_transition
...
-- Zrzut struktury tabela mysql.time_zone_transition_type
...
-- Zrzut struktury tabela mysql.transaction_registry
...
-- Zrzut struktury widok mysql.user
-- Tworzenie tymczasowej tabeli aby przezwyciężyć błędy z zależnościami w WIDOKU
CREATE TABLE `user` (
...
-- Zrzut struktury bazy danych performance_schema
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `performance_schema`;

-- Zrzut struktury tabela performance_schema.accounts
...
-- Zrzut struktury tabela performance_schema.cond_instances
...
-- Zrzut struktury tabela performance_schema.events_stages_current
...
-- Zrzut struktury tabela performance_schema.events_stages_history
...
-- Zrzut struktury tabela performance_schema.events_stages_history_long
...
-- Zrzut struktury tabela performance_schema.events_stages_summary_by_account_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_stages_summary_by_host_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_stages_summary_by_thread_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_stages_summary_by_user_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_stages_summary_global_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_statements_current
...
-- Zrzut struktury tabela performance_schema.events_statements_history
...
-- Zrzut struktury tabela performance_schema.events_statements_history_long
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_by_account_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_by_digest
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_by_host_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_by_thread_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_by_user_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_statements_summary_global_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_waits_current
...
-- Zrzut struktury tabela performance_schema.events_waits_history
...
-- Zrzut struktury tabela performance_schema.events_waits_history_long
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_by_account_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_by_host_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_by_instance
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_by_thread_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_by_user_by_event_name
...
-- Zrzut struktury tabela performance_schema.events_waits_summary_global_by_event_name
...
-- Zrzut struktury tabela performance_schema.file_instances
...
-- Zrzut struktury tabela performance_schema.file_summary_by_event_name
...
-- Zrzut struktury tabela performance_schema.file_summary_by_instance
...
-- Zrzut struktury tabela performance_schema.hosts
...
-- Zrzut struktury tabela performance_schema.host_cache
...
-- Zrzut struktury tabela performance_schema.mutex_instances
...
-- Zrzut struktury tabela performance_schema.objects_summary_global_by_type
...
-- Zrzut struktury tabela performance_schema.performance_timers
...
-- Zrzut struktury tabela performance_schema.rwlock_instances
...
-- Zrzut struktury tabela performance_schema.session_account_connect_attrs
...
-- Zrzut struktury tabela performance_schema.session_connect_attrs
...
-- Zrzut struktury tabela performance_schema.setup_actors
...
-- Zrzut struktury tabela performance_schema.setup_consumers
...
-- Zrzut struktury tabela performance_schema.setup_instruments
...
-- Zrzut struktury tabela performance_schema.setup_objects
...
-- Zrzut struktury tabela performance_schema.setup_timers
...
-- Zrzut struktury tabela performance_schema.socket_instances
...
-- Zrzut struktury tabela performance_schema.socket_summary_by_event_name
...
-- Zrzut struktury tabela performance_schema.socket_summary_by_instance
...
-- Zrzut struktury tabela performance_schema.table_io_waits_summary_by_index_usage
...
-- Zrzut struktury tabela performance_schema.table_io_waits_summary_by_table
...
-- Zrzut struktury tabela performance_schema.table_lock_waits_summary_by_table
...
-- Zrzut struktury tabela performance_schema.threads
...
-- Zrzut struktury tabela performance_schema.users
